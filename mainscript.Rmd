...
1. Brightness
```{r compare across bullocks groups - brightness}
# Boxplots
...
2. Chroma
```{r compare across bullocks groups - chroma}
# Boxplots
...
```{r compare across bullocks groups - hue}
# Boxplots
...
1. Brightness
```{r Compare across bullocks hybrid zone - brightness}
...
2. Chroma
```{r Compare across bullocks hybrid zone - chroma}
...
3. Hue
```{r Compare across bullocks hybrid zone - hue}
