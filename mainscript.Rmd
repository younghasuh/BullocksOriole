...
1. Brightness
```{r compare across bullocks groups - brightness, message = FALSE}
# Boxplots
...
2. Chroma
```{r compare across bullocks groups - chroma, message = FALSE}
# Boxplots
...
```{r compare across bullocks groups - hue, message = FALSE}
# Boxplots
